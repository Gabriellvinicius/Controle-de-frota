    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0f1115] relative overflow-hidden p-6">
            ...
            <div className="w-full max-w-[440px] relative z-10 animate-in fade-in zoom-in-95 duration-700">
                <div className="bg-white dark:bg-[#1c2229] border border-slate-200 dark:border-white/10 rounded-[2.5rem] p-10 md:p-12 shadow-[0_64px_128px_-16px_rgba(0,0,0,0.8)] backdrop-blur-xl relative overflow-hidden group">
                    ...
                    <div className="relative my-10">
                        ...
                        <div className="relative flex justify-center text-[10px]">
                            <span className="px-4 bg-white dark:bg-[#1c2229] text-slate-400 dark:text-slate-600 font-black uppercase tracking-widest">Sandbox e Teste</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-4 px-6 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em] hover:bg-slate-200 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white transition-all active:scale-[0.98]"
                    >
                        MODO DEMONSTRAÇÃO
                    </button>
                </div>
